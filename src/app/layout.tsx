...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Product Interview Q&A',
    template: '%s · Product Interview Q&A',
  },
  description:
  ...
  applicationName: 'Product Interview Q&A',
  openGraph: {
    type: 'website',
    siteName: 'Product Interview Q&A',
    locale: 'en_US',
    url: '/',
    title: 'Product Interview Q&A',
    description:
